...
files_to_download = {
    ...
    "documentation_logement": {"url": "https://www.data.gouv.fr/fr/datasets/r/c274705f-98db-4d9b-9674-578e04f03198", "filename": "RPindividus_doc.csv"},
    "documentation_individus": {"url": "https://www.data.gouv.fr/fr/datasets/r/1c6c6ab2-b766-41a4-90f0-043173d5e9d1", "filename": "RPlogement_doc.csv"},
...
documentation_logement = pd.read_csv("RPlogement_doc.csv", sep = ";")
documentation_individus = pd.read_csv("RPindividus_doc.csv", sep = ";")
```
